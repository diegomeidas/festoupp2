...
<head>
  ...
  <link rel="stylesheet" href="/res/site/css/toastr.min.css">
...
<div class="login-box">
  <div class="login-logo">
    <a href="/res/admin/index2.html"><b>Festou</b>PP</a>
  </div>
  <!-- /.login-logo -->
  <div class="login-box-body">
    ...
    <form action="" method="">
      ...
      <div class="row">
        ...
        <!-- /.col -->
        <div class="col-xs-4">
          <a id="btnLogin" class="btn btn-primary btn-block btn-flat">Entrar</a>
        </div>
        <!-- /.col -->
      </div>
    </form>
...
<script src="/res/site/js/toastr.min.js"></script>

<script src="/res/admin/dist/js/login.js"></script>
<script>
  $(function () {
    $('input').iCheck({
